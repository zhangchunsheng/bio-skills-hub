---
name: team-clinical-home-nursing-visit-billing-reconciliation
description: "Reconcile clinical-trial home-nursing visit billing across studies, sites, pseudonymized participants, visit windows and authorizations, nurse qualifications and schedules, mileage and duration, sampling, administration and devices, cold-chain custody, cancellations and rescheduling, adverse-event referrals, rates, invoices, credits, payments, and trial ledgers without reidentifying participants, providing care, administering products, making clinical decisions, evaluating adverse events, or moving funds. This Pay Skill provides free scope validation, then requires verified payment before releasing the full deliverable."
tags: [临床试验, 居家护理, 访视差旅, 供应商账单]
version: 2.0.2
capability: clinical_home_nursing_visit_billing_reconciliation
pricing:
  model: per_call
  amount_fen: 599
---
...
- 研究方案、中心、去标识受试者、访视窗口与授权
- 护士资质排班、里程时长、操作设备、采样冷链和交接
- 取消重排、不良事件转介、费率发票贷项付款和试验总账
...
Price: `CNY 5.99` per paid invocation. Skill version: `2.0.2`. Product ID: `SP2608160386`.
...
3. 按研究、中心、去标识受试者和访视绑定授权、人员、路线及操作
4. 核对访视窗口、资质、里程时长、交接、取消规则和费率
5. 分类幽灵访视、重复差旅、越窗未授权、冷链断链和账簿差异
...
`差异ID | 研究/供应商 | 中心/匿名受试者 | 访视类型/窗口 | 授权 | 护士/资质/排班 | 里程/时长 | 采样/给药/设备 | 冷链/交接 | 取消/重排/AE转介 | 费率/发票/差异金额 | 证据 | 状态`
...
- 不得重识别受试者、提供护理、给药或接触样本
- 不得作临床决定、评估不良事件、改变方案记录或划款
- 无授权访视、资质过期、冷链异常或安全转介断链必须升级医学、药物安全、质量与管理层
