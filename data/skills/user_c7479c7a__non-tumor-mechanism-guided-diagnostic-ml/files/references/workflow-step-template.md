...
Input:            Exact datasets / mechanism-gene lists / outputs from prior steps needed
...
1. **Dataset and Mechanism-Gene-Family Selection**
2. **Multi-Dataset Merging and Batch-Correction Review**
3. **Bulk DEG Analysis and Candidate Restriction**
4. **Feature Selection and Diagnostic-Model Construction**
5. **ROC / Calibration / DCA Evaluation**
6. **GO / KEGG / GSEA Interpretation**
7. **TF / miRNA Regulatory-Network and Immune Analysis**
8. **External Validation and Claim-Boundary Summary**
