...
- why the cancer context and target gene matter biologically or clinically
- why expression, survival, immune, and genomic / epigenetic branches are appropriate
- why the chosen portals, cohorts, and orthogonal validation resources are defensible
- whether similar single-gene oncology papers already exist
...
### 1. Background Cancer and Target-Gene Relevance
### 2. Method / Portal Justification
...
- official portal or platform page
