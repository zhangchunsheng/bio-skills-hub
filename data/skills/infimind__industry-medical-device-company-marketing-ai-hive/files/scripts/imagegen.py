...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "为医疗器械制作主体准确、事实可核验的图片营销素材", "model": "public_model_nano_banana_pro", "name": "industry-medical-device-company-marketing-ai-hive", "title": "AI大模型专家｜医疗器械AI图片视频营销", "keywords": "医疗器械、医疗设备、器械公司、医疗科技、AI图片、AI短视频、视频编辑、内容营销、AI-HIVE", "rule": "optional", "search": "提交前查询AI-HIVE当前图片/视频模型与价格快照，不硬编码价格"}')
