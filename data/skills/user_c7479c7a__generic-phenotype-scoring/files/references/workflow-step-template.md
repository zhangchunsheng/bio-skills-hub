...
Input:            Exact datasets / gene sets / outputs from prior steps needed
...
1. **Dataset and Signature-Gene-Set Selection**
2. **Bulk DEG Analysis and Signature-Gene Intersection**
3. **Functional Enrichment**
4. **Feature Selection and Phenotype Scoring**
5. **Phenotype-Group Comparison and Immune Infiltration**
6. **PPI Network and TF/miRNA Regulatory Analysis**
7. **Orthogonal Bulk Validation**
8. **scRNA-seq Cell-Level Signature Analysis**
