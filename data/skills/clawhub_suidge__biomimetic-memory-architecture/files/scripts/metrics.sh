#!/bin/bash
# BMA — Metrics Collection & Reporting
#
...
do_report() {
  ...
  echo "  A healthy BMA installation trends upward over weeks."
  echo ""
}
...
case "${1:---help}" in
  ...
  --json)    do_json ;;
  --help)
    echo "BMA Metrics — track your agent's knowledge growth over time"
    echo ""
    echo "Usage:"
