...
def main():
    parser = argparse.ArgumentParser(description="病鸡/病猪行为识别工具")
    ...
    parser.add_argument("--list", action='store_true', help="显示病鸡/病猪行为识别历史报告清单")
